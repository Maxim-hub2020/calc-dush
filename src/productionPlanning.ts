...
export const createProductionPackage = (
  ...
  return {
    ...
    templateChecks,
    warnings: [
      'Контуры отверстий и вырезов построены только для артикулов с подтверждёнными монтажными чертежами AV24.',
      ...
      'Высотное расположение петель и коннекторов выполнено по редактируемому производственному стандарту цеха и требует проверки перед выпуском.',
    ],
    blockingIssues,
    notes: '',

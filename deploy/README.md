...
Архив КП пока хранится в `localStorage`, поэтому архивы разных браузеров и iPhone остаются раздельными. Для общего архива потребуется отдельная серверная модель КП.
